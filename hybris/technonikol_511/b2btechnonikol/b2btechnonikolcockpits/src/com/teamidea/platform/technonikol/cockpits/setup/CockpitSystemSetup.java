 ...
 *  
 */
package com.teamidea.platform.technonikol.cockpits.setup;
...
import com.teamidea.platform.technonikol.cockpits.constants.B2btechnonikolCockpitsConstants;
 ...
 */
@SystemSetup(extension = B2btechnonikolCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(B2btechnonikolCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(B2btechnonikolCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						B2btechnonikolCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/b2btechnonikolcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
