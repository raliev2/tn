 ...
 *  
 */
package com.teamidea.platform.technonikol.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("b2btechnonikolcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("b2btechnonikolcockpits.product.externalTaxes"));
