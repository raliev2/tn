...
import com.teamidea.platform.technonikol.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/b2btechnonikolfulfilmentprocess/test/b2btechnonikolfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/b2btechnonikolfulfilmentprocess/test/b2btechnonikolfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/b2btechnonikolfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/b2btechnonikolfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/b2btechnonikolfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/b2btechnonikolfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/b2btechnonikolfulfilmentprocess/test/b2btechnonikolfulfilmentprocess-spring-testcleanup.xml"));
