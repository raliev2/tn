 ...
 *  
 */
package com.teamidea.platform.technonikol.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(B2btechnonikolFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(B2btechnonikolFulfilmentProcessConstants.PARENT_PROCESS);
