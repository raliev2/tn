 ...
 *  
 */
package com.teamidea.platform.technonikol.test.setup;
 ...
 */
@SystemSetup(extension = B2btechnonikolTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/b2btechnonikoltest/import/qa-organization.impex");
