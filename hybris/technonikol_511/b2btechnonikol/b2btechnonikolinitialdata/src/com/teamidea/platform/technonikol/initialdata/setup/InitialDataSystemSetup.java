 ...
 *  
 */
package com.teamidea.platform.technonikol.initialdata.setup;
 ...
 */
@SystemSetup(extension = B2btechnonikolInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "b2btechnonikolinitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "b2btechnonikolinitialdata", "yb2baccelerator", "yb2baccelerator", Collections.singletonList("yb2baccelerator"));
