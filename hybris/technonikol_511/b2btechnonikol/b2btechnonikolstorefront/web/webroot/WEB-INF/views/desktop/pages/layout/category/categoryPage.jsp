    ...
    <jsp:body>
        ...
        <section class="g-main-content clearfix">
            ...
            <div class="category-description">
                Проект «1Платформа» — это ведущий производитель и поставщик высококачественных товаров для строительства и ремонта на территории России и стран СНГ. Среди партнеров компании — крупнейшие бренды, которые заслужили доверие аудитории, а также новые недорогие марки, позволяющие экономить ваш бюджет. В результате, вы найдете подходящий товар вне зависимости от размеров вашего бюджета. «1Платформа» ежедневно пополняет свой каталог новыми товарами: мы первыми предлагаем актуальные новинки рынка.
            </div>
