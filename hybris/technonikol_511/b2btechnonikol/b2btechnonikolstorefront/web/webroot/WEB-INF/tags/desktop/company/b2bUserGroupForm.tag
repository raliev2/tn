...
<%@ attribute name="b2BUserGroupForm" required="true"
			  type="com.teamidea.platform.technonikol.storefront.forms.B2BUserGroupForm" %>
...
<form:form action="${formUrl}" method="post" commandName="b2BUserGroupForm">
		...
		<formUtil:formSelectBox idKey="b2busergroup.parent" labelKey="b2busergroup.parent"
								...
								<a href="${cancelUrl}" class="mycompany form no-confirm"><spring:theme code="b2busergroup.cancel" text="Cancel"/></a>
								<ycommerce:testId code="Unit_SaveChange_button">
									<button type="submit" class="mycompany form confirm"><spring:theme code="b2busergroup.save" text="Save Updates"/></button>
								</ycommerce:testId>
</form:form>
