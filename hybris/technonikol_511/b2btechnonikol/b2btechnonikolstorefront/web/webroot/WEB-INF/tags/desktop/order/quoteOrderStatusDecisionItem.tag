...
<%@ attribute name="quoteOrderForm" required="true" type="com.teamidea.platform.technonikol.storefront.forms.QuoteOrderForm"%>
		...
		<div class="item_container">
			<div class="right top">
				...
				<c:if 
					...
					<button class="positive left pad_right"
				...
				<c:if test="${orderData.status eq 'APPROVED_QUOTE'}">
					<button class="positive left pad_right"
						...
						onClick="ACC.quote.submitQuoteDecision('ACCEPTQUOTE');return false;">
