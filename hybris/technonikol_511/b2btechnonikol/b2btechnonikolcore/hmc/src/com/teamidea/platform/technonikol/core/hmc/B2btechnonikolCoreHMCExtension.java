 ...
 *  
 */
package com.teamidea.platform.technonikol.core.hmc;
...
/**
 * Provides necessary meta information about the b2btechnonikolcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class B2btechnonikolCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2btechnonikolCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.teamidea.platform.technonikol.core.hmc.locales";
