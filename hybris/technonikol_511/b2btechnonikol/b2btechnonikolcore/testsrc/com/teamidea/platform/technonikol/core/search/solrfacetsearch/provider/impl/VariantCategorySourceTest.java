 ...
 *  
 */
package com.teamidea.platform.technonikol.core.search.solrfacetsearch.provider.impl;
...
import com.teamidea.platform.technonikol.core.search.solrfacetsearch.provider.ProductSource;
...
public class VariantCategorySourceTest
{
	...
	private static final Integer SEQUENCE_FIRST = new Integer(1);
	private static final Integer SEQUENCE_SECOND = new Integer(2);
