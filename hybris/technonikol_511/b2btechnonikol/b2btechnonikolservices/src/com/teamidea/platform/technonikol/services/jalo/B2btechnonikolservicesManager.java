...
import com.teamidea.platform.technonikol.services.constants.B2btechnonikolservicesConstants;



/**
 * This is the extension manager of the B2btechnonikolservices extension.
 */
public class B2btechnonikolservicesManager extends GeneratedB2btechnonikolservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2btechnonikolservicesManager.class.getName());
	 ...
	 */
	public static B2btechnonikolservicesManager getInstance()
	{
		return (B2btechnonikolservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2btechnonikolservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2btechnonikolservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2btechnonikolservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2btechnonikolservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2btechnonikolservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
